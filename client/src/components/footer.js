                ...
                <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                    ...
                    <div class="mt-4">
                        <span class="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
                            ...
                            {/* github link */}
                            <a class="text-gray-500 cursor-pointer hover:text-gray-700" href="https://github.com/swaaap-nil">
                                <BsGithub/>
                            </a>

                            {/* leetcode link */}
                            <a class="ml-3 text-gray-500 cursor-pointer hover:text-gray-700" href="https://leetcode.com/swaaap-nil/">
                                <SiLeetcode/>
                            </a>

                            {/* twitter link */}
                            <a class="ml-3 text-gray-500 cursor-pointer hover:text-gray-700" href="https://twitter.com/swaap_nil">
                                <BsTwitter/>
                            </a>

                            {/* insta link */}
                            <a class="ml-3 text-gray-500 cursor-pointer hover:text-gray-700" href="https://www.instagram.com/swaap.nil/">
                                <BsInstagram/>
                            </a>

                            {/* linkedin link */}
                            <a class="ml-3 text-gray-500 cursor-pointer hover:text-gray-700" href="https://www.linkedin.com/in/swapnil-suman-7b169b212/">
